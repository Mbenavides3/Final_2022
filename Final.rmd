...
```{r}
effect <- FemaleData$p.value/(FemaleData$p.value +1)
FemaleEffectiveness = FemaleData$estimate/(FemaleData$estimate +1)*100
print(FemaleEffectiveness)

low=(FemaleData$conf.int[1]/(FemaleData$conf.int[1] +1))*100
hi=(FemaleData$conf.int[2]/(FemaleData$conf.int[2] +1))*100
options(digits=2)
```
